...
| 4   | Release-PR workflow bumps version + CHANGELOG; a manually-dispatched release workflow builds the `.vsix` and attaches it (+`.sha256`) to a draft GitHub release                                                                                                                                                                                | upstream `vscode-release-pr.yml`, `vscode-extension-release.yml` (both removed)                                                                                                   | — (done)            |
